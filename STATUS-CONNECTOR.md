...
can't reach the Vercel URL — network policy 403 — so the final live confirmation is owner-side,
which is inherent to a connector since Claude.ai is the client).
